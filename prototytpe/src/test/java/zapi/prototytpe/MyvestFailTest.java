...
public class MyvestFailTest {
	...
	public void setup() throws URISyntaxException, IOException {
		...
		ConnectionManager.createTestCycle("IM_PAM_HouseHoldManagement");
		ConnectionManager.createTestFolder();
		ConnectionManager.getFolderID();
		ConnectionManager.getTestID("AMMO-76268");
	...
	public void myVestLoginTest() {
		...
		Assert.assertEquals("https://tiaa.uatcan.myvest.com/u/1", driver.getCurrentUrl());
